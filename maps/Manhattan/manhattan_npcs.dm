/mob/living/carbon/human/npc/interactable/hotel/north
    products = list(
        list(
            "selled" = FALSE,
...
/mob/living/carbon/human/npc/interactable/retail/foodnorth
    products = list(
        list(
            "key" = "candy",
            "price" = 15,
...
/mob/living/carbon/human/npc/interactable/retail/mall/food
    products = list(
        list(
            "key" = "candy",
            "price" = 15,
...
/mob/living/carbon/human/npc/interactable/retail/north_streets/pizza_bob
    products = list(
        list(
            "key" = "margherita",
            "price" = 150,
...
/mob/living/carbon/human/npc/interactable/retail/north_streets/restaurant
    products = list(
        list(
            "key" = "tsoup",
            "price" = 200,
...
/mob/living/carbon/human/npc/interactable/retail/south
/mob/living/carbon/human/npc/interactable/retail/south/food_cheap
    products = list(
        list(
            "key" = "candy",
            "price" = 15,
