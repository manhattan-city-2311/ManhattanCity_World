...
/datum/controller/subsystem/xenoarch/proc/process_mineral(var/turf/simulated/mineral/M)
...
/datum/controller/subsystem/xenoarch/proc/handle_artifacts()
...
/datum/controller/subsystem/xenoarch/proc/SetupXenoarch()
	for(var/turf/simulated/mineral/M)
		if(M.density)
			process_mineral(M)
