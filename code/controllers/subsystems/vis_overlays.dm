...
/datum/controller/subsystem/vis_overlays/proc/add_vis_overlay(atom/movable/thing, icon, iconstate, layer, plane, dir, color, alpha=255)
	. = "[icon]|[iconstate]|[layer]|[plane]|[dir]|[color]|[alpha]"
	...
	if(!thing.managed_vis_overlays)
		...
		GLOB.dir_set_event.register(thing, src, /datum/controller/subsystem/vis_overlays/proc/rotate_vis_overlay)
	else
...
/datum/controller/subsystem/vis_overlays/proc/remove_vis_overlay(atom/movable/thing, list/overlays)
	...
	if(!length(thing.managed_vis_overlays))
		...
		GLOB.dir_set_event.unregister(thing, src, /datum/controller/subsystem/vis_overlays/proc/rotate_vis_overlay)
