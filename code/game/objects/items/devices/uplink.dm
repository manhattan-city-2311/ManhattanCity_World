...
/* How to create an uplink in 3 easy steps!
 ...
 2. Code in the triggers. Use check_trigger for this, I recommend closing the item's menu with "to_target(usr, browse(null, "window=windowname") if it returns true.)
...
/obj/item/device/uplink/hidden/process()
	if(world.time > next_offer_time)
		discount_item = default_uplink_selection.get_random_item(POSITIVE_INFINITY)
