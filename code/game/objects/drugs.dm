...
/obj/item/weapon/reagent_containers/powder/examine(mob/user)
	..()
	if(reagents)
		to_chat(user, "There's about <b>[reagents.total_volume] units</b> here.")
...
/obj/item/weapon/reagent_containers/powder/MiddleClick(mob/living/carbon/human/H)
	if(reagents)
		H.visible_message("<span class='warning'>[H] snorts [src]</span>")
		playsound(loc, 'sound/effects/snort.ogg', 50, 1)
