...
/datum/antagonist/loyalists
	...
	welcome_text = "You belong to the Company, body and soul. Preserve its interests against the conspirators amongst Нью-Манхэттен Сити."
	...
	faction_welcome = "Preserve NanoTrasen's interests against the traitorous recidivists amongst Нью-Манхэттен Сити. Protect the city council with your life."
