...
/obj/machinery/requests_console
	...
	desc = "A console intended to send requests to different departments on the city."
	anchored = 1
	icon = 'icons/obj/terminals.dmi'
	icon_state = "req_comp0"
	circuit = /obj/item/weapon/circuitboard/request
	var/department = "Unknown" //The list of all departments on the city (Determined from this variable on each unit) Set this to the same thing if you want several consoles in one department
