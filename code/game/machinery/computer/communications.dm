...
/obj/machinery/computer/communications/Topic(href, href_list)
	...
	if (using_map && !(src.z in using_map.contact_levels))
		to_chat(usr, "<font color='red'><b>Unable to establish a connection:</b></font> <font color='black'>You're too far away from the city!</font>")
		return
	usr.set_machine(src)
...
/obj/machinery/computer/communications/attack_hand(var/mob/user as mob)
	if(..())
		return
	if (using_map && !(src.z in using_map.contact_levels))
		to_chat(user, "<font color='red'><b>Unable to establish a connection:</b></font> <font color='black'>You're too far away from the city!</font>")
		return
