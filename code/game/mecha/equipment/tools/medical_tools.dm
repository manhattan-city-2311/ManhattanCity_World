/obj/item/mecha_parts/mecha_equipment/tool/sleeper
	...
	action(var/mob/living/carbon/human/target)
		...
		if(do_after_cooldown(target))
			...
			*/
			...
			occupant_message(SPAN_INFO("[target] successfully loaded into [src]. Life support functions engaged."))
	...
	proc/get_occupant_dam()
		...
		return {"<font color="[occupant.health > 50 ? "blue" : "red"]"><b>Health:</b> [occupant.health]% ([t1])</font><br />
					...
					<font color="[occupant.get_deprivation() < 60 ? "blue" : "red"]"><b>Respiratory Damage:</b> [occupant.get_deprivation()]%</font><br />
