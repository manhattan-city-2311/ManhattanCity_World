/obj/item/weapon/gun/energy/gun
	...
	firemodes = list(
		list(mode_name="stun", projectile_type=/obj/item/projectile/nonlethal, modifystate="energystun", charge_cost = 240),
...
//	one_handed_penalty = 15 // It's rather bulky, so holding it in one hand is a little harder than with two, however it's not 'required'.
	...
	firemodes = list(
		list(mode_name="stun", projectile_type=/obj/item/projectile/nonlethal, modifystate="nucgunstun", charge_cost = 240),
