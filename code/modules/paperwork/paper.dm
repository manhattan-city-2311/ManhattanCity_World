...
/obj/item/weapon/paper/attack_ai(var/mob/living/silicon/ai/user as mob)
	...
	if(dist < 2)
		usr << browse("<meta charset='utf-8'><HEAD><TITLE>[name]</TITLE></HEAD><BODY>[info][stamps]</BODY></HTML>", "window=[name]")
		onclose(usr, "[name]")
	else
		usr << browse("<meta charset='utf-8'><HEAD><TITLE>[name]</TITLE></HEAD><BODY>[stars(info)][stamps]</BODY></HTML>", "window=[name]")
		onclose(usr, "[name]")
	return
...
/obj/item/weapon/paper/attack(mob/living/carbon/M as mob, mob/living/carbon/user as mob)
	if(user.zone_sel.selecting == O_EYES)
		...
		if(ishuman(M))
			...
			if(H == user)
				to_chat(user, "<span class='notice'>You wipe your face with the [src].</span>")
				H.remove_face_style()
				H.update_icons_body()
			else
...
/obj/item/weapon/paper/Court
	name = "Judgement"
	info = "<font face=\"Verdana\" color=black><center><H2>Нью-Манхэттен Сити High Court</H2><BR><B>Official Court Ruling</B><BR><img src = ntlogo.png><BR></center><BR><HR><BR><font size = \"1\">The following constitutes an official, legally binding decision of the Geminus High Court.<BR><BR>On the following charges, the defendant is hereby found:</font><BR><BR><font size = \"1\"><B>(Guilty - G)<BR>(Not Guilty - NG)</B></font><BR><HR><BR><span class=\"paper_field\"></span><BR><BR><HR><BR><font size = \"1\"><BR><B>So orders the Нью-Манхэттен Сити High Court:</B></font><BR><BR><BR><B><font size = \"1\">Judge&#39;s signature:</font></B><BR><span class=\"paper_field\"></span><BR><BR><HR><BR><font size = \"1\"><B><U>Official Document of Нью-Манхэттен Сити Court. Forgery of this document is a crime.</U></B></font></font>"
