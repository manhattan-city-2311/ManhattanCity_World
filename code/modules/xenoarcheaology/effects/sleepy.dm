...
/datum/artifact_effect/sleepy/DoEffectTouch(var/mob/toucher)
	if(toucher)
		...
		if(ishuman(toucher) && prob(weakness * 100))
			...
			H << pick(SPAN_INFO("You feel like taking a nap."), "<font color='blue'> You feel a yawn coming on.</font>","<font color='blue'> You feel a little tired.")
	...
	if(holder)
		...
		for (var/mob/living/carbon/human/H in range(src.effectrange,T))
			...
			if(prob(weakness * 100))
				if(prob(10))
					H << pick(SPAN_INFO("You feel like taking a nap."), "<font color='blue'> You feel a yawn coming on.</font>","<font color='blue'> You feel a little tired.</font>")
