...
/proc/get_records_blank()
	return list(
		...
		, "ЦВЕТ ВОЛОС" = null
		, "ЦВЕТ ГЛАЗ" = null
		, "ЭТНИЧНОСТЬ" = list(list("Меонец", "Марсианин (Тунеллер)", "Марсианин (Мансинец)", "Венерианец", "Селениан (Низший)", "Селениан (Высший)", "Землянин", "Фобас", "Цереровец", "Плутонец", "Цетит", "Спейсер (Центральный)", "Спейсер (Фронтир)", "Теранец", "Магнитовец", "Гайец (ЦПСС)", "Гайец (ГГК)"), null)
