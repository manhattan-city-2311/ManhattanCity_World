...
/datum/category_item/player_setup_item/antagonism/basic/content(var/mob/user)
	...
	. +="<b>Тип аплинка : <a href='?src=\ref[src];antagtask=1'>[pref.uplinklocation]</a></b>"
	. +="<br>"
	. +="<b>Компромат:</b><br>"
...
/datum/category_item/player_setup_item/antagonism/basic/OnTopic(var/href,var/list/href_list, var/mob/user)
	...
	if(href_list["antagfaction"])
		var/choice = input(user, "Please choose an antagonistic faction to work for.", "Character Preference", pref.antag_faction) as null|anything in antag_faction_choices + list("None")
