/datum/category_item/player_setup_item/general/backstory/load_character(var/savefile/S)
	S["language"]			>> pref.alternate_languages
	S["language_prefixes"]	>> pref.language_prefixes

/datum/category_item/player_setup_item/general/backstory/save_character(var/savefile/S)
	S["language"]			<< pref.alternate_languages
	S["language_prefixes"]	<< pref.language_prefixes

/datum/category_item/player_setup_item/general/backstory/delete_character()
	pref.alternate_languages = null
	pref.language_prefixes = null

/datum/category_item/player_setup_item/general/backstory/sanitize_character()
...
/datum/category_item/player_setup_item/general/backstory/content()
	. += "<b>Бэк:</b><br>"
	var/datum/species/S = all_species[pref.species]
	if(S.language)
		. += "- [S.language]<br>"
	...
	if(S.num_alternate_languages)
		if(pref.alternate_languages.len)
			for(var/i = 1 to pref.alternate_languages.len)
				...
				. += "- [lang] - <a href='?src=\ref[src];remove_language=[i]'>удалить</a><br>"

		if(pref.alternate_languages.len < S.num_alternate_languages)
			. += "- <a href='?src=\ref[src];add_language=1'>add</a> ([S.num_alternate_languages - pref.alternate_languages.len] осталось)<br>"
	else
...
/datum/category_item/player_setup_item/general/backstory/OnTopic(var/href,var/list/href_list, var/mob/user)
	if(href_list["remove_language"])
		...
		var/datum/species/S = all_species[pref.species]
		if(pref.alternate_languages.len >= S.num_alternate_languages)
			alert(user, "Вы уже выбрали максимальное количество языков для этой расы!")
		else
			...
			if(!available_languages.len)
				alert(user, "Больше нет языков для выбора.")
			else
