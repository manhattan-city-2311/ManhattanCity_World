...
//Drugs reactions (WIP)
/datum/chemical_reaction/solidification/cocaine
    name = "Solid Cocaine"
    required_reagents = list("frostoil" = 5, "cocaine" = REAGENTS_PER_SHEET)
    sheet_to_give = /obj/item/weapon/reagent_containers/pill/cocaine
