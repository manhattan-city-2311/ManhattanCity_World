...
/obj/item/organ/internal/brain/vatborn/examine(mob/user) // -- TLE
	...
	if(brainmob && brainmob.client)//if thar be a brain inside... the brain.
		to_chat(user, "The stack glows with a bright blue hue signifying an active consciousness.")
	else
		to_chat(user, "The stock glows with a dim red hue signifying an inactive consciousness. Perhaps it will regain some of its luster later...")
...
/obj/item/organ/internal/fake_brain/removed(mob/living/user)
