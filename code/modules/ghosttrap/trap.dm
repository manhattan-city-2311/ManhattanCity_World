...
/datum/ghosttrap/proc/welcome_candidate(var/mob/target)
	...
	to_chat(target, "<b>As a synthetic intelligence, you answer to all city residents, as well as the AI.</b>")
	to_chat(target, "<b>Remember, the purpose of your existence is to serve the residents and the city. Above all else, do no harm.</b>")
