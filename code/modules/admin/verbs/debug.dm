	...
	if(M)
		if(M.mind in ticker.mode.cult)
			...
			if(alert("Spawn that person a tome?",,"Yes","No")=="Yes")
				to_chat(M, "<font color='red'>You catch a glimpse of the Realm of Nar-Sie, The Geometer of Blood. You now see how flimsy the world is, you see that it should be open to the knowledge of Nar-Sie. A tome, a message from your new master, appears on the ground.</font>")
				new /obj/item/weapon/book/tome(M.loc)
			else
				to_chat(M, "<font color='red'>You catch a glimpse of the Realm of Nar-Sie, The Geometer of Blood. You now see how flimsy the world is, you see that it should be open to the knowledge of Nar-Sie.</font>")
			var/glimpse=pick("1","2","3","4","5","6","7","8")
			switch(glimpse)
				if("1")
					to_chat(M, "<font color='red'>You remembered one thing from the glimpse... [cultwords["travel"]] is travel...</font>")
				if("2")
					to_chat(M, "<font color='red'>You remembered one thing from the glimpse... [cultwords["blood"]] is blood...</font>")
				if("3")
					to_chat(M, "<font color='red'>You remembered one thing from the glimpse... [cultwords["join"]] is join...</font>")
				if("4")
					to_chat(M, "<font color='red'>You remembered one thing from the glimpse... [cultwords["hell"]] is Hell...</font>")
				if("5")
					to_chat(M, "<font color='red'>You remembered one thing from the glimpse... [cultwords["destroy"]] is destroy...</font>")
				if("6")
					to_chat(M, "<font color='red'>You remembered one thing from the glimpse... [cultwords["technology"]] is technology...</font>")
				if("7")
					to_chat(M, "<font color='red'>You remembered one thing from the glimpse... [cultwords["self"]] is self...</font>")
				if("8")
					to_chat(M, "<font color='red'>You remembered one thing from the glimpse... [cultwords["see"]] is see...</font>")
...
/client/proc/cmd_display_init_log()
	...
	if(!check_rights(R_DEBUG))	return
	src << browse(replacetext_char(SSatoms.InitLog(), "\n", "<br>"), "window=initlog")
