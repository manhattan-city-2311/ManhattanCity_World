...
/datum/admins/proc/player_panel_new()//The new one
	...
	to_target(usr, browse(dat, "window=players;size=600x480"))
...
/datum/admins/proc/player_panel_old()
	...
	to_target(usr, browse(dat, "window=players;size=640x480"))
...
/datum/admins/proc/check_antagonists()
	if (ticker && ticker.current_state >= GAME_STATE_PLAYING)
		...
		dat += "</body></html>"
		to_target(usr, browse(dat, "window=roundstatus;size=400x500"))
	else
