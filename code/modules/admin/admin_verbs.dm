...
//	/client/proc/toggle_hear_deadcast,	//toggles whether we hear deadchat,
	...
	/client/proc/cmd_admin_cmed_dump,
...
/client/proc/invisimin()
	...
	if(holder && mob)
		if(mob.invisibility == INVISIBILITY_OBSERVER)
			...
			to_chat(mob, SPAN_INFO("<b>Invisimin on. You are now as invisible as a ghost.</b>"))
...
/client/proc/drop_bomb() // Some admin dickery that can probably be done better -- TLE
	...
	message_admins(SPAN_INFO("[ckey] creating an admin explosion at [epicenter.loc]."))
...
/client/proc/give_disease2(mob/T as mob in mob_list) // -- Giacom
	...
	message_admins(SPAN_INFO("[key_name_admin(usr)] gave [key_name(T)] a [greater] disease2 with infection chance [D.infectionchance]."), 1)
...
/client/proc/make_sound(var/obj/O in world) // -- TLE
	...
	if(O)
		...
		message_admins(SPAN_INFO("[key_name_admin(usr)] made [O] at [O.x], [O.y], [O.z]. make a sound."), 1)
...
/client/proc/readmin_self()
	...
	if(deadmin_holder)
		...
		to_chat(src, "<span class='interface'>You now have the keys to control the planet, or atleast a small city</span>")
...
/client/proc/man_up(mob/T as mob in mob_list)
	...
	message_admins(SPAN_INFO("[key_name_admin(usr)] told [key_name(T)] to man up and deal with it."), 1)
...
/client/proc/global_man_up()
	...
	message_admins(SPAN_INFO("[key_name_admin(usr)] told everyone to man up and deal with it."), 1)
...
/client/proc/give_spell(mob/T as mob in mob_list) // -- Urist
	...
	message_admins(SPAN_INFO("[key_name_admin(usr)] gave [key_name(T)] the spell [S]."), 1)
...
/client/proc/global_erp()
	...
	for (var/mob/T as mob in mob_list)
		to_chat(T, "<br><center><span class='notice'><b><font size=4>ERP DETECTED.<br> Purge of the source of erotic roleplay will commence shortly.</font></b><br></span></center><br>")
...
/client/proc/erp(mob/T as mob in mob_list)
	...
	to_chat(T, "<span class='danger'><b><font size=3>ERP DETECTED.</font></b></span>")
	to_chat(T, "<span class='danger'>Jesus will be visiting shortly...</span>")
	T << 'sound/effects/erpdetected.wav'
