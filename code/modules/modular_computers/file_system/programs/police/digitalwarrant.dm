...
/datum/computer_file/program/digitalwarrant/proc/print_warrant(mob/user)
	...
	if(activewarrant.fields["arrestsearch"] == "arrest")
		...
		output = {"
		<HTML><meta charset=\"UTF-8\"><HEAD><TITLE>[activewarrant.fields["namewarrant"]]</TITLE></HEAD>
		<BODY bgcolor='#FFFFFF'><center><large><b>Нью-Манхэттен Сити Police Department Bureau</b></large></br>
		...
		Area of Warrant: _<u>Нью-Манхэттен Сити</u>____</br>
	...
	if(activewarrant.fields["arrestsearch"] == "search")
		output= {"
		<HTML><meta charset=\"UTF-8\"><HEAD><TITLE>Search Warrant: [activewarrant.fields["namewarrant"]]</TITLE></HEAD>
		...
		Location: _<u>Нью-Манхэттен Сити</u>____</br>
		</BODY></HTML>
		"}
