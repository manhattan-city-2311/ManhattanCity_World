...
/datum/erp_action/moan/get_messages(mob/living/carbon/human/user1)
	var/list/msgs1 = list(
		"@1 краснеет и по [pronounce_helper(user1, "его", "её")] телу проходит рой мурашек.",
		"@1 громко сглатывает.",
	...
	var/list/msgs2 = list(
		...
		"@1 тяжело дышит, [pronounce_helper(user1, "его", "её")] тело все подрагивает.",
	...
	var/list/msgs3 = list(
		...
		"@1 запрокидывает голову назад, приоткрыв рот, [pronounce_helper(user1, "его", "её")] глаза непроизвольно закатываются.",
