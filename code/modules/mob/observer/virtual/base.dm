...
/mob/observer/virtual/shall_have_virtual_mob()
	return FALSE
...
/mob/observer/virtual/New(var/location, var/atom/movable/host)
	...
	src.host = host
	GLOB.moved_event.register(host, src, /atom/movable/proc/move_to_destination)
...
/mob/observer/virtual/Destroy()
	GLOB.moved_event.unregister(host, src, /atom/movable/proc/move_to_destination)
	all_virtual_listeners -= src
	host = null
	return ..()
