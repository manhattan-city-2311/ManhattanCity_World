...
/obj/item/weapon/robot_module
	...
	var/channels = list()
	var/networks = list()
	var/languages = list(LANGUAGE_FRENCH = 1, LANGUAGE_UNATHI = 0, LANGUAGE_SIIK = 0, LANGUAGE_AKHANI = 0, LANGUAGE_SKRELLIAN = 0, LANGUAGE_GUTTER = 0, LANGUAGE_SCHECHI = 0, LANGUAGE_SIGN = 0)
	var/sprites = list()
	var/can_be_pushed = 1
	var/no_slip = 0
