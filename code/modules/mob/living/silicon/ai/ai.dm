...
/mob/living/silicon/ai/proc/on_mob_init()
	to_chat(src, "<B>You are playing the city's AI. The AI cannot move, but can interact with many objects while viewing them (through cameras).</B>")
	to_chat(src, "<B>To look at other parts of the city, click on yourself to get a camera menu.</B>")
