...
/mob/living/carbon/human/show_inv(mob/user as mob)
	...
	if(intubated)
		dat += "<BR><A href='?src=\ref[src];item=intubation'>Remove intubation tube</A>"
...
/mob/living/carbon/human/proc/play_xylophone()
	if(!src.xylophone)
		...
		visible_message("<font color='red'>\The [src] begins playing [T.his] ribcage like a xylophone. It's quite spooky.</font>", SPAN_INFO("You begin to play a spooky refrain on your ribcage."),"<font color='red'>You hear a spooky xylophone melody.")
...
/mob/living/carbon/human/proc/morph()
	...
	check_dna()
	var/datum/gender/T = gender_datums[get_visible_gender()]
	visible_message(SPAN_INFO("\The [src] morphs and changes [T.his] appearance!"), "<font color='blue'>You change your appearance!</font>", "<font color='red'>Oh, god!  What the hell was that?  It sounded like flesh getting squished and bone ground into a different shape!")
