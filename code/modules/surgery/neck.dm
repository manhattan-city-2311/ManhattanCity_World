...
/datum/surgery_step/brainstem/mend_vessels/end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	user.visible_message(SPAN_INFO("[user] has mended the blood vessels on [target]'s brainstem with \the [tool].") , \
	SPAN_INFO(" You have mended the blood vessels on [target]'s brainstem with \the [tool]."),)
...
/datum/surgery_step/brainstem/drill_vertebrae/end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
	user.visible_message(SPAN_INFO("[user] has drilled around [target]'s brainstem with \the [tool].") , \
	SPAN_INFO(" You have drilled around [target]'s brainstem with \the [tool]."),)
...
/datum/surgery_step/brainstem/clean_chips/end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	user.visible_message(SPAN_INFO("[user] has cleaned around [target]'s brainstem with \the [tool].") , \
	SPAN_INFO(" You have cleaned around [target]'s brainstem with \the [tool]."),)
...
/datum/surgery_step/brainstem/mend_cord/end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	user.visible_message(SPAN_INFO("[user] has fused [target]'s spinal cord with \the [tool].") , \
	SPAN_INFO(" You have fused [target]'s spinal cord with \the [tool]."),)
...
/datum/surgery_step/brainstem/mend_vertebrae/end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	user.visible_message(SPAN_INFO("[user] has mended [target]'s vertebrae with \the [tool].") , \
	SPAN_INFO(" You have mended [target]'s vertebrae with \the [tool]."),)
	target.can_defib = 1
...
/datum/surgery_step/brainstem/realign_tissue/end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	user.visible_message(SPAN_INFO("[user] has realigned the tissues in [target]'s skull back into place with \the [tool].") , \
	SPAN_INFO(" You have realigned the tissues in [target]'s skull back into place with \the [tool]."),)
