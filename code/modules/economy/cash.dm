...
/obj/item/weapon/spacecash/attackby(obj/item/weapon/W as obj, mob/user as mob)
	if(istype(W, /obj/item/weapon/spacecash))
		...
		to_chat(user, "<span class='notice'>You add [cash2text( worth, FALSE, TRUE, TRUE )] credits worth of money to the bundles.<br>It holds [cash2text( bundle.worth, FALSE, TRUE, TRUE )] credits now.</span>")
		qdel(src)
