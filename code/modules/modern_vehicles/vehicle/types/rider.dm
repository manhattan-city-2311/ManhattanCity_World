/obj/item/vehicle_part/engine/rider
	name = "Rider's brand engine"
...
/obj/item/vehicle_part/gearbox/rider
	name = "Rider's brand gearbox"
	mass = 12
	gears = list(
		"R"  = -6,
		"N"  = 0,
...
/obj/item/vehicle_part/fueltank/rider
	capacity = 40

/obj/manhattan/vehicle/motorcycle/rider
	name = "Rider"
	...
	components = list(
		...
		VC_ENGINE = /obj/item/vehicle_part/engine/rider,
		VC_GEARBOX = /obj/item/vehicle_part/gearbox/rider,
		VC_CARDAN = /obj/item/vehicle_part/cardan,
		VC_FUELTANK = /obj/item/vehicle_part/fueltank/rider
	)
...
/obj/manhattan/vehicle/motorcycle/rider/get_braking_force()
	return 2000
