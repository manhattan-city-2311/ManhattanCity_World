...
/datum/bounty/proc/replace_all_strings()
	description = replacetext_char(description, "’", "'")
	description = replacetext_char(description, "%DOCKNAME",using_map.dock_name)
	description = replacetext_char(description, "%BOSSNAME",using_map.boss_name)
	description = replacetext_char(description, "%BOSSSHORT",using_map.boss_short)
	description = replacetext_char(description, "%COMPNAME",using_map.company_name)
	description = replacetext_char(description, "%COMPSHORT",using_map.company_short)
	description = replacetext_char(description, "%AUTHOR",author)
	description = replacetext_char(description, "%CASHWANTED", "[cash2text(cash_wanted, FALSE, TRUE, TRUE )]")
	description = replacetext_char(description, "%CASHINDIE", "[cash2text(individual_reward, FALSE, TRUE, TRUE )]")
	description = replacetext_char(description, "%CASHDEPT", "[cash2text(department_reward, FALSE, TRUE, TRUE )]")
