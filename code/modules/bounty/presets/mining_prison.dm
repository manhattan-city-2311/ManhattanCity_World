/datum/bounty/prison_mining
	...
	author = "Нью-Манхэттен Сити Factory"
...
/datum/bounty/prison_mining/phoron // yes science is on it too
	...
	description = "Нью-Манхэттен Сити laboratories requires phoron deposits for research purposes, please send a supply when you can."
...
/datum/bounty/prison_mining/phoron_healthcare // yes even the hospital
	...
	description = "Нью-Манхэттен Сити hospital's pharmacist sector requires large amounts of phoron to keep productivity running, please send supplies."
