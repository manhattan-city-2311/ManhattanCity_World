...
/datum/looping_sound/proc/sound_loop(starttime)
	...
	if(!timerid)
		timerid = addtimer(CALLBACK(src, GLOBAL_PROC_REF(sound_loop), world.time), mid_length, TIMER_STOPPABLE | TIMER_LOOP)
...
/datum/looping_sound/proc/on_start()
	...
	addtimer(CALLBACK(src, GLOBAL_PROC_REF(sound_loop)), start_wait)
