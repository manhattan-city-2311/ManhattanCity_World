var/global/const/base_law_type = /datum/ai_laws/pollux
...
/datum/ai_laws/proc/set_state_law_internal(var/list/datum/ai_law/laws, var/list/state, var/list/datum/ai_law/law, do_state)
	var/index = laws.Find(law)
	if(index)
